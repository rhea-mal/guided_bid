...
class PushTEnv(gym.Env):
    ...
    def __init__(self,
        ...
        # self.perturb_level = Vec2d(1.0, 1.0) * perturb doesnt work like this
    ...
    def step(self, action):
        ...
        # self.block.position += np.array(self.perturb) THIS ISNT WORKING
    ...
    def _render_frame(self, mode):
        ...
        # WIND RENDER
        # wind_magnitude = np.linalg.norm(self.perturb)  # Magnitude of the perturb vector
        # if wind_magnitude > 0:
        #     wind_direction = np.arctan2(self.perturb[1], self.perturb[0])  # Angle of the vector
        ...
        #     # Draw magnitude of wind as a loading bar in the top right corner
        #     max_wind_magnitude = 4  # Adjust this value according to your max wind magnitude
